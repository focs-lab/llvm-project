...
void InitializeLibrary() {
#if defined(USE_PSAN_CALLBACKS)
  callback_register_tag = (decltype(callback_register_tag))dlsym(RTLD_DEFAULT, "__psan_external_register_tag");
  callback_assign_tag = (decltype(callback_assign_tag))dlsym(RTLD_DEFAULT, "__psan_external_assign_tag");
  callback_read = (decltype(callback_read))dlsym(RTLD_DEFAULT, "__psan_external_read");
  callback_write = (decltype(callback_write))dlsym(RTLD_DEFAULT, "__psan_external_write");
