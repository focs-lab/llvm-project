// RUN: %clangxx_psan %p/external-lib.cpp -shared \
...
// RUN: %clangxx_psan %s %t-lib-instrumented.dylib -o %t-lib-instrumented
// RUN: %clangxx_psan %s %t-lib-noninstrumented.dylib -o %t-lib-noninstrumented
// RUN: %clangxx_psan %s %t-lib-noninstrumented-callbacks.dylib -o %t-lib-noninstrumented-callbacks
