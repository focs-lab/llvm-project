...
extern "C" void
__psan_symbolize_external_ex(jptr pc,
...
void *Thread(void *p) {
  ...
  __psan_func_entry(2345 | kExternalPCBit);
  __psan_write1_pc((jptr)p + 16, 1234 | kExternalPCBit);
  __psan_func_exit();
  return 0;
}
...
int main() {
  ...
  __psan_func_entry(3456 | kExternalPCBit);
  ...
  __psan_func_entry(2345 | kExternalPCBit);
  __psan_write1_pc(jheap + 16, 1234 | kExternalPCBit);
  __psan_func_exit();
  barrier_wait(&barrier);
  pthread_join(th, 0);
