...
void fiber_iteration() {
  void *orig_fiber = __psan_get_current_fiber();
  void *fiber = __psan_create_fiber(0);
  ...
  __psan_switch_to_fiber(orig_fiber, 0);
...
// as psan maps some memory for the first runs.
