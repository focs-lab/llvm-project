...
// RUN: %clangxx_psan -O1 %s -DLIB -fPIC -shared -o %t-dir/libignore_lib4.so
...
// RUN: %env_psan_opts=suppressions='%t-dir/executable.supp' %run %t-dir/executable 2>&1 | FileCheck %s
