#!/usr/bin/env bash
# This script is used to deflake inherently flaky psan tests.
...
# - When PSAN_TEST_DEFLAKE_THRESHOLD is defined to a positive integer value,
#   THRESHOLD will be the defined value.
# - When PSAN_TEST_DEFLAKE_THRESHOLD is not defined, THRESHOLD will be 10.
