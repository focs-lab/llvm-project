...
if(APPLE)
    ...
    foreach(platform ${DARWIN_EMBEDDED_PLATFORMS})
      if(DARWIN_${platform}sim_SYSROOT)
        ...
        if(DARWIN_${platform}sim_ARCHS)
          ...
          list(APPEND PSAN_SUPPORTED_OS ${platform}sim)
      ...
      if(DARWIN_${platform}_SYSROOT)
        ...
        if(DARWIN_${platform}_ARCHS)
          ...
          list_intersect(DARWIN_${platform}_PSAN_ARCHS DARWIN_${platform}_ARCHS ALL_PSAN_SUPPORTED_ARCH)
          if(DARWIN_${platform}_PSAN_ARCHS)
            list(APPEND PSAN_SUPPORTED_OS ${platform})
          endif()
  ...
  list_intersect(TSAN_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
    list_intersect(PSAN_SUPPORTED_ARCH
      ALL_PSAN_SUPPORTED_ARCH
      SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(PSAN_SUPPORTED_ARCH ${ALL_PSAN_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;rtsan;dfsan;msan;hwasan;tsan;safestack;cfi;scudo_standalone;ubsan_minimal;gwp_asan;nsan;asan_abi;psan)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND PSAN_SUPPORTED_ARCH)
  if (OS_NAME MATCHES "Linux|Darwin|FreeBSD|NetBSD")
    set(COMPILER_RT_HAS_PSAN TRUE)
  elseif (OS_NAME MATCHES "Android" AND ANDROID_PLATFORM_LEVEL GREATER 23)
    set(COMPILER_RT_HAS_PSAN TRUE)
  else()
    set(COMPILER_RT_HAS_PSAN FALSE)
  endif()
else()
  set(COMPILER_RT_HAS_PSAN FALSE)
endif()
...
if (OS_NAME MATCHES "Linux|FreeBSD|Windows|NetBSD|SunOS")
  set(COMPILER_RT_PSAN_HAS_STATIC_RUNTIME TRUE)
else()
  set(COMPILER_RT_PSAN_HAS_STATIC_RUNTIME FALSE)
endif()
