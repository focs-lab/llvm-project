#!/usr/bin/env bash
#
# Script that checks that critical functions in PSan runtime have correct number
...
# psan interceptors. When such a change happens, you can ensure that the
...
# update:
# ./projects/compiler-rt/lib/psan/tests/rtl/PsanRtlTest-x86_64-Test
...
SCRIPTDIR=$(dirname $0)
RES=$(${SCRIPTDIR}/analyze_libpsan.sh $1)
PrintRes() {
  printf "%s\n" "$RES"
}
