...
#ifndef PSAN_SPINLOCK_DEFS_MAC_H
#define PSAN_SPINLOCK_DEFS_MAC_H
...
declarations to prevent compilation errors in psan_interceptors_mac.cpp, which
references these functions when defining PSAN interceptor functions.
*/
...
#endif //PSAN_SPINLOCK_DEFS_MAC_H
