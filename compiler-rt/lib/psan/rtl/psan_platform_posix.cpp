...
void InitializeShadowMemory() {
  ...
  on_initialize = reinterpret_cast<void (*)(void)>(
      dlsym(RTLD_DEFAULT, "__psan_on_initialize"));
  on_finalize =
      reinterpret_cast<int (*)(int)>(dlsym(RTLD_DEFAULT, "__psan_on_finalize"));
}
...
// CheckAndProtect will check if the memory layout is compatible with PSan.
