...
// These need to match __psan_mutex_* flags defined in psan_interface.h.
// See documentation there as well.
enum MutexFlags {
  MutexFlagLinkerInit          = 1 << 0, // __psan_mutex_linker_init
  MutexFlagWriteReentrant      = 1 << 1, // __psan_mutex_write_reentrant
  MutexFlagReadReentrant       = 1 << 2, // __psan_mutex_read_reentrant
  MutexFlagReadLock            = 1 << 3, // __psan_mutex_read_lock
  MutexFlagTryLock             = 1 << 4, // __psan_mutex_try_lock
  MutexFlagTryLockFailed       = 1 << 5, // __psan_mutex_try_lock_failed
  MutexFlagRecursiveLock       = 1 << 6, // __psan_mutex_recursive_lock
  MutexFlagRecursiveUnlock     = 1 << 7, // __psan_mutex_recursive_unlock
  MutexFlagNotStatic           = 1 << 8, // __psan_mutex_not_static
...
// descriptors. It uses 1/2 direct shadow, see psan_platform.h for the mapping.
class MetaMap {
 public:
  MetaMap();
