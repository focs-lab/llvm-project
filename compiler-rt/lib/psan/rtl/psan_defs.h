...
// and it's prohibited to include std headers into psan runtime.
...
#ifndef PSAN_NO_HISTORY
# define PSAN_NO_HISTORY 0
#endif

#ifndef PSAN_CONTAINS_UBSAN
# if CAN_SANITIZE_UB && !SANITIZER_GO
#  define PSAN_CONTAINS_UBSAN 1
# else
#  define PSAN_CONTAINS_UBSAN 0
# endif
#endif
...
constexpr Sid kFreeSid = static_cast<Sid>(kThreadSlotCount-1);
...
enum ExternalTag : uptr {
  ...
  // as 16-bit values, see psan_defs.h.
};
